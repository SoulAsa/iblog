	...
	<body>
		...
		<div class="template">
		  <div class="box">
		    ...
		    <ul>
		      <li><a href="/" target="_blank"><img src="${pageContext.request.contextPath }/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
		      <li><a href="/"  target="_blank"><img src="${pageContext.request.contextPath }/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
		      <li><a href="/" target="_blank"><img src="${pageContext.request.contextPath }/images/04.jpg"></a><span>女生清新个人博客网站模板</span></li>
		      <li><a href="/"  target="_blank"><img src="${pageContext.request.contextPath }/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
		      <li><a href="/"  target="_blank"><img src="${pageContext.request.contextPath }/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
